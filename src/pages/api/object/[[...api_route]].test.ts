...
const mockRes: Partial<NextApiResponse<ObjectResponse | ObjectListResponse | ErrorResponse>> = {
...
describe('[[...api_route]].ts', () => {
    ...
    it('should handle object list route', () => {
        ...
        handler(mockReq as NextApiRequest, mockRes as NextApiResponse<ObjectResponse | ObjectListResponse | ErrorResponse>);
    ...
    it('should handle get object route', () => {
        ...
        mockReq.method = 'GET';
        handler(mockReq as NextApiRequest, mockRes as
